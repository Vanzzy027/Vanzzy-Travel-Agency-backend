...
export const VehicleSchema = z.object({
  ...
  status: z
    .enum(["Available", "Rented", "Maintenance", "Unavailable", "Banned"])
    .default("Available"),
});
...
export type VehicleSpecCreateData = z.infer<typeof VehicleSpecSchema>;

export type VehicleSpecUpdateData = z.infer<typeof VehicleSpecUpdateSchema>;
