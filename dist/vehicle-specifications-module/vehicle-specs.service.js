...
export const createVehicleSpecService = async (data) => {
    try {
...
export const getVehicleSpecByIdService = async (id) => {
    try {
        const pool = await getDbPool();
...
export const updateVehicleSpecService = async (id, data) => {
    try {
        const pool = await getDbPool();
        const fields = [];
...
export const deleteVehicleSpecService = async (id) => {
    try {
        const pool = await getDbPool();
...
export const getVehicleSpecsByTypeService = async (vehicleType) => {
    try {
        const pool = await getDbPool();
