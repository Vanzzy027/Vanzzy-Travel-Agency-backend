import { createVehicleService, getAllVehiclesService, getVehicleByIdService, updateVehicleService, deleteVehicleService, getAvailableVehiclesService, updateVehicleStatusService } from "./vehicles.service.js";
...
export const getAvailableVehicles = async (c) => {
    try {
...
export const updateVehicleStatus = async (c) => {
    try {
        const id = parseInt(c.req.param('id'));
        if (isNaN(id) || id <= 0) {
            return c.json({ error: "Invalid vehicle ID" }, 400);
